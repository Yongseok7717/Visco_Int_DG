...
s1Hu=np.loadtxt("H1_error_linear_disp_S1.txt")
s1Lu=np.loadtxt("L2_error_linear_disp_S1.txt")
s1Lw=np.loadtxt("L2_error_linear_velo_S1.txt")
s1Hw=np.loadtxt("H1_error_linear_velo_S1.txt")


s2Hu=np.loadtxt("H1_error_linear_disp_S2.txt")
s2Lu=np.loadtxt("L2_error_linear_disp_S2.txt")
s2Lw=np.loadtxt("L2_error_linear_velo_S2.txt")
s2Hw=np.loadtxt("H1_error_linear_velo_S2.txt")
...
annotation.slope_marker((4.8,-6),-1,invert=True)
annotation.slope_marker((4.8,-12),-2,invert=True)
